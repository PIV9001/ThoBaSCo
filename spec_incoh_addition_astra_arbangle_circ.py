...
wsize = 300
wvec = np.linspace(0.01,1.2,wsize)*(w0*4*gamma**2)
...
tvplot, phi = pathphase_circ_spec(dist, tgrange, wsize, evec0, bvec0, gamma)
...
#    #
#    #
#    tvec, phi = pathphase_circ_spec(dist, tgrange, wsize, evec, bvec, gamma)
#    #
#    #
#    bvec = np.dot(rotmat,bvec)
#    #
#    for cnt2 in range(1,nmax+1):
#        #Atheta, Aphi = arb_angle_circ_spec(evec, bvec, wvec, tvec, phi, a0, w0, gvec[cnt], N0, cnt2)
#        intpart = arb_angle_circ_spec(evec, bvec, wvec, tvec, phi, a0, w0, gvec[cnt], N0, cnt2)
#        #
#        Intsum += intpart
#        #
#    print(cnt)
...
for cnt in range(Ne2):
    ...
    for cnt2 in range(1,nmax+1):
        #emittance test
        intpart = arb_angle_circ_spec(evec, bvec, wvec, tvec, phi, a0, w0, gvect[cnt], N0, cnt2)
        #
        Intsum += intpart
        #
    print(cnt)
...
#MESA:
name1 = 'MESA_circ_{}e_'.format(Ne2)
...
#              
#
#testdict = {'axis1':axis1, 'axis2':axis2, 'data': Intsum}
